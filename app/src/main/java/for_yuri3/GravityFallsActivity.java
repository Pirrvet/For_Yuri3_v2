...
import for_yuri3.questions.gravityFallsQuestions;

import static for_yuri3.R.id.buttona5;

public class GravityFallsActivity extends AppCompatActivity {
...
//private  int nQuestionLength = nQuestions.nQuestions.length;
    ...
    Random r;
    ArrayList<String> questionList = new ArrayList<>(Arrays.asList(gravityFallsQuestions.fQuestions));
    ArrayList<String[]> choiceList = new ArrayList<>(Arrays.asList(gravityFallsQuestions.fChoices));
    ArrayList<String> correctAnswerList = new ArrayList<>(Arrays.asList(gravityFallsQuestions.fCorrectAnswers));
...
//List<String> correctAnswerList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //r =new Random();
        button1 = (Button) findViewById(R.id.buttongrav1);
        button2 = (Button) findViewById(R.id.buttongrav2);
        button3 = (Button) findViewById(R.id.buttongrav3);
        button4 = (Button) findViewById(R.id.buttongrav4);
        question = (TextView) findViewById(R.id.questiongrav);
...
//        correctAnswerList = Arrays.asList(Questions.nCorrectAnswers);
    ...
    private void winAskOnceAgain() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GravityFallsActivity.this);
        alertDialogBuilder
                .setMessage("Игра окончена")
                .setCancelable(false)
                .setPositiveButton("Новая игра", new DialogInterface.OnClickListener() {
