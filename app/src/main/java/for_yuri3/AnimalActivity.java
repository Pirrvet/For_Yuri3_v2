...
import for_yuri3.questions.animanlQuestions;
...
//private  int nQuestionLength = nQuestions.nQuestions.length;
    ...
    Random r;
    ArrayList<String> questionList = new ArrayList<>(Arrays.asList(animanlQuestions.aQuestions));
    ArrayList<String[]> choiceList = new ArrayList<>(Arrays.asList(animanlQuestions.aChoices));
    ArrayList<String> correctAnswerList = new ArrayList<>(Arrays.asList(animanlQuestions.aCorrectAnswers));
