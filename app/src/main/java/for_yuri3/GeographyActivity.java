...
//private  int nQuestionLength = nQuestions.nQuestions.length;
    ...
    Random r;
    ArrayList<String> questionList = new ArrayList<>(Arrays.asList(geographyQustions.gQuestions));
    ArrayList<String[]> choiceList = new ArrayList<>(Arrays.asList(geographyQustions.gChoices));
    ArrayList<String> correctAnswerList = new ArrayList<>(Arrays.asList(geographyQustions.gCorrectAnswers));
...
//List<String> correctAnswerList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //r =new Random();
        button1 = (Button) findViewById(R.id.buttong1);
        button2 = (Button) findViewById(R.id.buttong2);
        button3 = (Button) findViewById(R.id.buttong3);
        button4 = (Button) findViewById(R.id.buttong4);
        question = (TextView) findViewById(R.id.questiong);
...
//        correctAnswerList = Arrays.asList(Questions.nCorrectAnswers);
    ...
    private void winAskOnceAgain() {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GeographyActivity.this);
        alertDialogBuilder
                .setMessage("Игра окончена")
                .setCancelable(false)
                .setPositiveButton("Новая игра", new DialogInterface.OnClickListener() {
