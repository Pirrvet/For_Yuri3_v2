...
//
//    Random r;
//    ArrayList<String> questionList = new ArrayList<String>(Arrays.asList(Questions.nQuestions));
...
//
//        r = new Random();
////        questionList = (ArrayList<String>) Arrays.asList(Questions.nQuestions);
...
//                    {
//                        gameOver();  // добавить новйы активити дял ВИНа, не гамовер
//                    }
//
//                    updateQuestion(r.nextInt(questionList.size()));
//                }
